...
local Window = Library.CreateLib("KenanUI", "GrapeTheme")


local Tab     = Window:NewTab("Drop Items")
local Section = Tab:NewSection("Drop Ben and Banana")
...
Section:NewButton("Dupe Watermelon", "Buy item dupe cash", function()
local args = {
        [1] = "Watermelon"
    }
...
Section:NewButton("Dupe Bad Tommeh", "Buy item dupe cash", function()
local args = {
        [1] = "Bad Tommeh"
    }
...
Section:NewButton("Dupe Baby Mermaid (If you win the game)", "Buy item dupe cash", function()
local args = {
        [1] = "Baby Mermaid"
    }
...
Section:NewButton("Buy Ben", "Cost 1 M", function()
    local args = {
        [1] = "Trading Ben"
    }
...
Section:NewButton("Buy Munneh", "Cost 50k", function()
    local args = {
        [1] = "Munneh"
    }
...
Section:NewButton("Buy Mommeh Long Legs", "Cost 500k", function()
    local args = {
        [1] = "Mommeh Long Legs"
    }
...
local Section = Tab:NewSection("Crash Server function")
...
Section:NewKeybind("Open or close UI Press F", "Open or close UI Press F", Enum.KeyCode.F, function()
    Library:ToggleUI()
end)
Section:NewLabel("Teleport Trading platform")
Section:NewButton("TP Platform 1", "ButtonInfo", function()
...
Section:NewButton("TP Platform 2", "ButtonInfo", function()
...
Section:NewButton("TP Platform 3", "ButtonInfo", function()
...
Section:NewButton("TP Platform 4", "ButtonInfo", function()
...
Section:NewButton("TP Platform 5", "ButtonInfo", function()
...
Section:NewButton("TP Platform 6", "ButtonInfo", function()
...
Section:NewButton("TP Platform 7", "ButtonInfo", function()
...
Section:NewButton("TP Platform 1(left)", "ButtonInfo", function()
...
Section:NewButton("TP Platform 2(left)", "ButtonInfo", function()
...
Section:NewButton("TP Platform 3(left)", "ButtonInfo", function()
...
Section:NewButton("TP Platform 4(left)", "ButtonInfo", function()
...
Section:NewButton("TP Platform 5(left)", "ButtonInfo", function()
...
Section:NewButton("TP Platform 6(left)", "ButtonInfo", function()
...
local Section = Tab:NewSection("Working Scam script")
Section:NewButton("Scam Script", "Scam ppl", function()
...
local Section = Tab:NewSection("Sell Reaper.")

Section:NewButton("Get money", "Buy item dupe cash", function()
...
Section:NewButton("click here to get more", "Buy item dupe cash", function() 
local args = {
...
end)Section:NewButton("click here to get more", "Buy item dupe cash", function()
...
local Section = Tab:NewSection("Crash Script")

Section:NewButton("Click here to crash and get ur items back", "Click her to crash and get ur items back", function()
